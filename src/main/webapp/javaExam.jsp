<%@ page import="com.example.text.JavaEntity" %>
...
<div class="container">
    ...
    <form id="examForm" action="submitExamJava" method="post" enctype="application/x-www-form-urlencoded">
        <% for (JavaEntity question : (List<JavaEntity>) request.getAttribute("javaQuestions")) { %>
        <div class="question">
